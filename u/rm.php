...
<body onload="removeButton()">
    ...
    <?php
        $busca_itens = DBRead('solicita', "WHERE id_rm='$id_rm'");
            ...
            if ($busca_itens == true){
                ...
                $assinatura_u = isset($busca_ass[0]['assinatura_u'])?"<div  style='text-align:center'><strong>".$busca_ass[0]['assinatura_u']."<strong></div>":' Não assinado';
    ...
    ?>
	<tr>
		<td style="border: 1px solid #000000;" colspan=4 rowspan=2 height="54" align="left" valign=top><font color="#000000">ASS REQUISITANTE<br/><div id="ass"><?php print($assinatura_u." "); ?><button id="btn_ass" onclick="assinar(<?php echo($id_rm); ?>)"> Assinar</button></div></font></td>
		<td style="border: 1px solid #000000;" rowspan=2 align="left" valign=top><font color="#000000">ASS AUTORIZA&Ccedil;&Atilde;O</font></td>
	...
	<tr>
		...
		<td align="left" valign=bottom><font color="#000000"><a href="./index.php">voltar</a></font></td>
	</tr>
</table>
