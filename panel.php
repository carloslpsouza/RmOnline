...
<body>
    <div class="conteiner">
        <div class="minhas_rms"><legend>Rms em aberto - <?php print($setor[0]['descricao']." - ".$nome." - "); ?><a href="logout.php">Sair</a><hr></legend>
            <?php
                $busca_rm = DBRead('rm', "WHERE id_func='$id_func' AND assinatura is NULL");
                if ($busca_rm == true){
                    ...
                    foreach ($busca_rm as $dt){
                        $assinatura = isset($dt['assinatura'])?'Assinado':' Não assinado';
                        print("<div class='linha'><div class='coluna' style='width: 25px;'><a href='rm.php?rm=".$dt['id_rm']."'>".$dt['id_rm']."</a></div><div class='coluna' style='width: 200px;'>".$dt['data']."</div><div class='coluna' style='width: 200px;'>".$dt['c_custo']."</div><div class='coluna' style='width: 100px;'>".$dt['tipo']."</div><div class='coluna' style='width: 200px;'> ".$assinatura."</div><div class='coluna' style='width: 100px;'> ".$dt['estado']."</div><div class='coluna'>".$trash."</div><div class='coluna'>".$edit."</div></div>");
                    }
                }
                else{
        ...
        <?php
                $busca_rm = DBRead('rm', "WHERE id_func='$id_func' AND assinatura is not NULL");
                if ($busca_rm == true){
                    print("<div class='linha'><div class='titulo_coluna' style='width: 25px;'> RM </div><div class='titulo_coluna' style='width: 200px;'> Data </div><div class='titulo_coluna' style='width: 200px;'> Centro de custo </div><div class='titulo_coluna' style='width: 100px;'> Tipo </div><div class='titulo_coluna' style='width: 200px;'> Aprovação </div><div class='titulo_coluna' style='width: 100px;'> Estado </div></div>");
                    //var_dump($busca_rm);
